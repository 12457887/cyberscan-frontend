// Proxy GET /service/admin/medianet-sites -> backend /admin/medianet-sites
...
export async function GET(req: Request) {
  try {
    ...
    const target = `${backendUrl}/admin/medianet-sites${queryString ? `?${queryString}` : ''}`;
    ...
    console.error('Proxy error /admin/medianet-sites:', err);
