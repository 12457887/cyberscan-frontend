// Proxy route: forwards GET /service/scan-status/:scan_id to the backend FastAPI service
...
export async function GET(
  ...
  try {
    ...
    const res = await fetch(`${backendUrl}/scan-status/${encodeURIComponent(scan_id)}`, {
      method: 'GET',
      headers,
    });
