...
// app/service/generate-report-network/[id]/route.ts
...
export async function GET(
  ...
  try {
    ...
    const res = await fetch(`${backendUrl}/generate-report-network/${id}?report_format=${format}`, {
      method: "GET",
      headers,
    });
    ...
    const suggestedFilename =
      ...
      `rapport-network-${id}.${format === "xlsx" ? "xlsx" : format === "json" ? "json" : "pdf"}`;
